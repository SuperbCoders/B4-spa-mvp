...
import { Card, CardTitle, CardContent, CardIcon, CardControls } from 'components/common/Card';
        ...
        <div className="mvp-action-cards">
          <Card className="mvp-action-card" horizontal>
            ...
            <CardContent>
              ...
              Добавьте контактные данные, банковские счета, сведения о ключевых персонах. Часть данных заполнена из открытых источников.
            </CardContent>

            <CardControls position="right">
              <Button theme="light" onClick={() => processModalResultOpen(true)}>Перейти</Button>
            </CardControls>
          </Card>
          ...
          <Card className="mvp-action-card" horizontal>
            ...
            <CardContent>
              ...
              Вам потребуются сканы устава, паспорта генерального директора, отчетность за пошлый год – и другие стандартные  документы о компании.
            </CardContent>

            <CardControls position="right">
              <Button theme="light" onClick={() => processModalOpen(true)}>Перейти</Button>
            </CardControls>
          </Card>
        </div>
