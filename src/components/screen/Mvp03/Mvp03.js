...
export default function MVP() {
  ...
  return (
    <PageLayout>
            ...
            <Card className="tender">
              <CardContent className="tender-body">
                <div className="tender-info">
                  <Button size="sm" appearance="primary" className="tender-risk-rate">
                    Вероятность победы:
                    <span className="tender-risk-rate-percent">78%</span>
                    <span className="tender-risk-rate-cta">
                      <span role="img" aria-label="Огонь">🔥</span>&nbsp;Давай! 
                    </span>
                  </Button>
                  <div className="tender-title">
                    Закупка услуг по изготовлению и монтажу мебели в ЦПО. Общество с ограниченной ответственностью “КТ Мобайл”
                  </div>
                  <div className="tender-company">Общество с ограниченной ответственностью “БрингМеталлСервис”</div>
                </div>
              ...
              <CardFooter className="tender-footer">
                ...
                <IconButton  skin="orange" appearance="ghost" className="tender-favorites" icon={ <FeaturedOutline width="20" height="20" /> } />
                <div className="tender-guarantee-status">
                  Гарантия одобрена
                  <span className="tender-guarantee-status-price">5 000 ₽</span>
                </div>
                <Button skin="light" appearance="ghost" arrow className="tender-proceed-btn">Изучить тендер</Button>
              </CardFooter>
            </Card>
          </div>
        </section>
          ...
          <div className="tenders-group-cards">
            <Card className="tender">
              ...
              <CardFooter className="tender-footer">
                ...
                <IconButton skin="orange" className="tender-favorites" icon={ <Featured width="20" height="20" /> }/>
                <div className="tender-guarantee-status">
                  Гарантия одобрена
                  <span className="tender-guarantee-status-price">5 000 ₽</span>
                </div>
      ...
      <Whisper placement="topEnd" trigger="hover" speaker={
        <Tooltip className="mvp-tooltip">
          Заявка на гарантию
        </Tooltip>
      }>
        <IconButton
