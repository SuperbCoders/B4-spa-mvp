...
export default function UploadModal(props) {
  ...
  return <Modal dialogClassName="modal upload-modal" overflow={ false } size="lg" show={ show } onHide={ toggle } backdrop={ true }>
    <Modal.Header>
        ...
        <div className="upload-modal-disclaimer-col">
          <div className="documents-disclaimer">
            ...
            <ul className="documents-disclaimer-list">
              <li className="documents-disclaimer-list-item">Бухгалтерская  отчетность (год)</li>
              <li className="documents-disclaimer-list-item">Бухгалтерская  отчетность (квартал)</li>
              <li className="documents-disclaimer-list-item">Устав</li>
              <li className="documents-disclaimer-list-item">Решение/Доверенность</li>
              <li className="documents-disclaimer-list-item">Паспорт</li>
              <li className="documents-disclaimer-list-item">Договор Аренды /право Cобстветнности</li>
            </ul>
          </div>
        </div>
      </div>
